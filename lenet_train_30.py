...
if __name__ == '__main__':
    ...
    train_db = dats_pipleline(train_X, train_Y, BATCH_SIZE=128, img_size=[32, 32])
    test_db = dats_pipleline(test_X, test_Y, BATCH_SIZE=128, img_size=[32, 32])
